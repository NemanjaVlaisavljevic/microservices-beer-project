...
public class BeerOrderManagerImplIntegrationTest {
    ...
    void testNewToPickedUp() throws JsonProcessingException {
        ...
        beerOrderManager.allocatedToPickedUp(savedBeerOrder.getId());
    ...
    @Test
    void testFailedAllocationError() throws JsonProcessingException {
        BeerDto beerDto = BeerDto.builder().id(beerId).upc("12345").build();
        ...
        AllocationFailEvent allocationFailEvent = (AllocationFailEvent)
                jmsTemplate.receiveAndConvert(JmsConfig.ALLOCATION_FAILED_QUEUE);
        assertNotNull(allocationFailEvent);
        assertThat(allocationFailEvent.getOrderId()).isEqualTo(savedBeerOrder.getId());
    }

   @Test
   void testFailedPendingInventory() throws JsonProcessingException {
       ...
       BeerOrder beerOrder = createBeerOrder();
       beerOrder.setCustomerRef("fail-pending-inventory");
